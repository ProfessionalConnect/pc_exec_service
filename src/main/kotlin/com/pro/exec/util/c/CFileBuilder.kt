...
import com.pro.exec.util.file.ExecutionFileExtension.WINDOW
import java.io.File
...
object CFileBuilder {
    ...
    fun makeExecuteCode(fileStatusSender: FileStatusSender): FileStatusSender {
        var status = true
        val processBuilder = ProcessBuilder("gcc", fileStatusSender.fileName, "-o", fileStatusSender.originalFileName)
        ...
        val newFileName = "${fileStatusSender.originalFileName}${WINDOW}"
